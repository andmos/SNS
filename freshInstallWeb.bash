...
programs="build-essential vim ssh curl htop git make traceroute tcptraceroute screen apache2 php5 mysql-server php5-mysql php5-mysqlnd php-mdb2-driver-mysql mysql-libs" 
